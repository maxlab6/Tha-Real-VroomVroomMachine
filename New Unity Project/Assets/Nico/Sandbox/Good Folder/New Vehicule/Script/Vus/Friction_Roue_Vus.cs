...
public class Friction_Roue_Vus : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Terrain01 = GameObject.Find("Map/Land Plot/Terrain_1").GetComponent<Terrain>();
        Terrain02 = GameObject.Find("Map/Land Plot/Terrain_2").GetComponent<Terrain>();
        Terrain03 = GameObject.Find("Map/Land Plot/Terrain_3").GetComponent<Terrain>();
        Terrain04 = GameObject.Find("Map/Land Plot/Terrain_4").GetComponent<Terrain>();
        Terrain05 = GameObject.Find("Map/Land Plot/Terrain_5").GetComponent<Terrain>();
        Terrain06 = GameObject.Find("Map/Land Plot/Terrain_6").GetComponent<Terrain>();
        Terrain07 = GameObject.Find("Map/Land Plot/Terrain_7").GetComponent<Terrain>();
        Terrain08 = GameObject.Find("Map/Land Plot/Terrain_8").GetComponent<Terrain>();
        Terrain09 = GameObject.Find("Map/Land Plot/Terrain_9").GetComponent<Terrain>();
        Terrain10 = GameObject.Find("Map/Land Plot/Terrain_10").GetComponent<Terrain>();
        Terrain11 = GameObject.Find("Map/Land Plot/Terrain_11").GetComponent<Terrain>();
        Terrain12 = GameObject.Find("Map/Land Plot/Terrain_12").GetComponent<Terrain>();
        Terrain13 = GameObject.Find("Map/Land Plot/Terrain_13").GetComponent<Terrain>();
        Terrain14 = GameObject.Find("Map/Land Plot/Terrain_14").GetComponent<Terrain>();
        Terrain15 = GameObject.Find("Map/Land Plot/Terrain_15").GetComponent<Terrain>();
        Terrain16 = GameObject.Find("Map/Land Plot/Terrain_16").GetComponent<Terrain>();
