...
public class Controle_Pickup : MonoBehaviour
{
    ...
    {
        //RigidBody
        rb = GameObject.Find("SandBox/Pickup Jeu").GetComponent<Rigidbody>();

        //Wheel Collider
        WC_FL = GameObject.Find("SandBox/Pickup Jeu/Wheel_Collider/WC_FL").GetComponent<WheelCollider>();
        WC_FR = GameObject.Find("SandBox/Pickup Jeu/Wheel_Collider/WC_FR").GetComponent<WheelCollider>();
        WC_RL = GameObject.Find("SandBox/Pickup Jeu/Wheel_Collider/WC_RL").GetComponent<WheelCollider>();
        WC_RR = GameObject.Find("SandBox/Pickup Jeu/Wheel_Collider/WC_RR").GetComponent<WheelCollider>();

        //Wheel Transform
        WT_FL = GameObject.Find("SandBox/Pickup Jeu/Wheel_Transform/WT_FL").GetComponent<Transform>();
        WT_FR = GameObject.Find("SandBox/Pickup Jeu/Wheel_Transform/WT_FR").GetComponent<Transform>();
        WT_RL = GameObject.Find("SandBox/Pickup Jeu/Wheel_Transform/WT_RL").GetComponent<Transform>();
        WT_RR = GameObject.Find("SandBox/Pickup Jeu/Wheel_Transform/WT_RR").GetComponent<Transform>();

        //Trail Transform
        Trail_FL = GameObject.Find("SandBox/Pickup Jeu/Trail_Maker/Trail_Maker_FL").GetComponent<Transform>();
        Trail_FR = GameObject.Find("SandBox/Pickup Jeu/Trail_Maker/Trail_Maker_FR").GetComponent<Transform>();
        Trail_RL = GameObject.Find("SandBox/Pickup Jeu/Trail_Maker/Trail_Maker_RL").GetComponent<Transform>();
        Trail_RR = GameObject.Find("SandBox/Pickup Jeu/Trail_Maker/Trail_Maker_RR").GetComponent<Transform>();

        //Trail Renderer
        Trail_Maker_FL = GameObject.Find("SandBox/Pickup Jeu/Trail_Maker/Trail_Maker_FL").GetComponent<TrailRenderer>();
        Trail_Maker_FR = GameObject.Find("SandBox/Pickup Jeu/Trail_Maker/Trail_Maker_FR").GetComponent<TrailRenderer>();
        Trail_Maker_RL = GameObject.Find("SandBox/Pickup Jeu/Trail_Maker/Trail_Maker_RL").GetComponent<TrailRenderer>();
        Trail_Maker_RR = GameObject.Find("SandBox/Pickup Jeu/Trail_Maker/Trail_Maker_RR").GetComponent<TrailRenderer>();
    }
