...
public class Pathfinding : MonoBehaviour {
    ...
    public Transform TemporaryPosition = null;
    ...
    {
        foreach(Transform finish in TargetPosition)
        {
            if (TemporaryPosition == null)
            {
                FindPath(StartPosition.position, finish.position);
            }
            else
            {
                FindPath(TemporaryPosition.position, finish.position);
            }

            TemporaryPosition = finish;
        }
